...
public class BasariliMarket {
    ...
    */
	 ...
	 static List<String> urunler = Arrays.asList("Domates", "Patates" ,"Biber", "Soğan", "Havuç", "Elma", "Muz", "Çilek" , "Kavun", "Üzüm" , "Limon");
	...
	public static void main(String[] args) {
		...
		if (cvp) {
			...
			System.out.println("Lutfen istediginiz urunun miktarini kg cinsinden giriniz");
		...
		if(!cvp) {
			...
			System.out.println("Lutfen odeyeceginiz tutari giriniz");
		    double odeme=scan.nextDouble();
			System.out.println("\n\t\t FATURA ");
			System.out.println();
			sepetYazdir(toplamFiyat);
			   odeme(toplamFiyat, odeme);
		}
	...
	private static void odeme(double toplamFiyat, double odeme) {
		...
		else System.out.println("Eksik odeme  yaptiniz...");
